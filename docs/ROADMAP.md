...
- `BiliKitCore` 本地 Swift Package，以及 `BiliModels`、`BiliApplication`、`BiliNetworking`、`BiliAuth`、`BiliAuthFeature`、`BiliAPI`、`BiliPlayback`、`BiliBrowseFeature`、`BiliLibraryFeature` 九个模块。
...
- 118 个 Package 测试、21 个测试套件、1 个 App composition 单元测试和 1 个签名 Keychain smoke；原 App 业务测试已迁移到对应 Application/Feature target。
